...
a persistence unit "web applicationPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "web application\pom.xml":
...
artifact ("web application.war") is already built. You can build
